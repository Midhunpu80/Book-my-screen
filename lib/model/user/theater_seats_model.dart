...
//
//     final allseats10 = allseats10FromJson(jsonString);

import 'dart:convert';

Allseats10 allseats10FromJson(String str) => Allseats10.fromJson(json.decode(str));

String allseats10ToJson(Allseats10 data) => json.encode(data.toJson());
...
class Allseats10 {
    ...
    factory Allseats10.fromJson(Map<String, dynamic> json) => Allseats10(
