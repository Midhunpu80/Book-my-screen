...
carousalAvailMovies() {
  ...
  return Obx(
    () =>   availmoviesx.allmoviesdetailsdata.isEmpty?Center(child: CircularProgressIndicator()): Container(
      height: 35.h,
      width: 100.w,
      ...
      child: ListView.separated(
          ...
          itemCount: availmoviesx.allmoviesdetailsdata.length > 5 ? 5 :availmoviesx.allmoviesdetailsdata.length),
    ),
  );
}
